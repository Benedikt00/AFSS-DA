...
\subsubsection{Schaltplan - Zeichenprozess}\mbox{}\\
    ...
    Damit wäre die Kommunikation von Treiber, Motor und Geber gezeichent. Doch es gehört auch die Kommunikation zur SPS dazu. Der Treiber hat folgende Kontakte: 
    \begin{itemize}
        \item PUL+ 
        \item PUL-
        \item DIR+
