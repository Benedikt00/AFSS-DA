...
\paragraph{Einbindung ins TIA-Portal}\mbox{}\\
...
\begin{wrapfigure}{r}{0.4\textwidth}
    \vspace{-20px}
    \includegraphics[width=0.5\textwidth]{Sensors/BarScan_Geräteübersicht.png}
