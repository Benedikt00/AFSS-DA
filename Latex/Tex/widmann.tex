...
Zum Überprüfen, ob während des Ein- oder Auslagerns eine Box auf der richtigen Position angekommen ist, werden Lichttaster verwendet. Insgesamt werden zwei am AFSS montiert, davon einer an der z-Achse und einer am Querförderer. Es handelt sich hierbei um Lichttaster der Firma SICK vom Typ W4 WTBxx (siehe Abb.)
\textbf{warum keine lichtschranken}
Das SPS-Programm wartet auf das Signal des jeweiligen Lichttasters, bevor sie das Programm fortsetzt. Somit wird sichergestellt, dass die Boxen von der z-Achse richtig gegriffen werden.

\begin{figure}[H]
    \centering
    \begin{subfigure}{.3\textwidth}
        \centering
        \includegraphics[width=0.5\textwidth]{Sensors/Lichttaster.png}
        \caption{Lichttaster W4 WTBxx\cite{Lichttaster_pic}}
        \label{lichttaster}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{Sensors/Barcodescanner.png}
