...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Sponsors/KNAPP.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Sponsors/weidmueller.png}
...
\textbf{igus} = \textbf{I}ndustriespritz\textbf{gus}s (vgl. \cite{igus}). Für das Firmenlogo siehe Abb.\ref{fig:igus_logo}.\\
